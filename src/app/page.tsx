...
import { FirstTimeTutorialHome } from "@/components/onboarding/first-time-tutorial";
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-16 px-4 py-16">
        ...
        <section className="grid gap-10 md:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)] items-center">
          <div>
            <div className="mb-4 inline-flex items-center justify-center rounded-full bg-primary/10 px-3 py-1 text-xs font-medium text-primary">
          ...
          <div className="space-y-4 rounded-xl border border-border bg-card/70 p-4 text-xs text-muted-foreground shadow-sm">
        ...
        <section id="criar-sala" className="grid gap-6 sm:grid-cols-2 scroll-mt-24">
